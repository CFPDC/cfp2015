...
<main role="main" class="container-fluid search-results secondary">
  <div class="row">
    <div class="col-xs-12 hidden-xs sort-display-menu-container">
      <div class="pull-right sort-display-menu">
        ...
        <ul class="collapse sort-by list-unstyled dropdown-menu normal" id="sortBy">
          <li>
            <a href="javascript:void(0);" data-sort="category">Category</a>
          </li>
          <li>
            <a href="javascript:void(0);" data-sort="name">Name</a>
          </li>
          <li>
            <a href="javascript:void(0);" data-sort="region">Region</a>
          </li>
          <li>
            <a href="javascript:void(0);" data-sort="year">Year</a>
          </li>
        </ul>
      ...
      <div>
        ...
        <div class="collapse selections" id="natureSearch">
          ...
          <ul class="list-unstyled normal">
            <li>
              <label for="animals">
                <input type="checkbox" id="animals" class="natureSubCat">
                Animals (
            ...
            <li>
              <label for="environment">
                <input type="checkbox" id="environment" class="natureSubCat">
                Environment (
                <span class="environ-count">
                  3
                </span>
      ...
      <div>
        ...
        <div class="collapse selections" id="cultureSearch">
          ...
          <ul class="list-unstyled normal">
            <li>
              <label for="kid-art">
                <input type="checkbox" id="kid-art" class="cultureSubCat">
            ...
            <li>
              <label for="arts">
                <input type="checkbox" id="arts" class="cultureSubCat">
                Arts &amp; Culture (
          ...
          <ul class="list-unstyled normal">
            <li>
              <label for="enrichment">
                <input type="checkbox" id="enrichment" class="educationSubCat">
            ...
            <li>
              <label for="literacy">
                <input type="checkbox" id="literacy" class="educationSubCat">
                Literacy &amp; Learning (
                <span class="arts-count">
                  3
                </span>
            ...
            <li>
              <label for="schools">
                <input type="checkbox" id="schools" class="educationSubCat">
                Schools (
                <span class="arts-count">
                  3
                </span>
      ...
      <div>
        ...
        <div class="collapse selections" id="humanServicesSearch">
          ...
          <ul class="list-unstyled normal">
            <li>
              <label for="Aging">
                <input type="checkbox" id="Aging" class="humanServicesSubCat">
                Aging (
                <span class="kid-art-count">
                  4
                </span>
            ...
            <li>
              <label for="families">
                <input type="checkbox" id="families" class="humanServicesSubCat">
            ...
            <li>
              <label for="commDev">
                <input type="checkbox" id="commDev" class="humanServicesSubCat">
            ...
            <li>
              <label for="women">
                <input type="checkbox" id="women" class="humanServicesSubCat">
                Girls &amp; Women (
                <span class="kid-art-count">
                  4
                </span>
            ...
            <li>
              <label for="health">
                <input type="checkbox" id="health" class="humanServicesSubCat">
            ...
            <li>
              <label for="housing">
                <input type="checkbox" id="housing" class="humanServicesSubCat">
            ...
            <li>
              <label for="hunger">
                <input type="checkbox" id="hunger" class="humanServicesSubCat">
                Hunger (
                <span class="kid-art-count">
                  4
                </span>
            ...
            <li>
              <label for="justice">
                <input type="checkbox" id="justice" class="humanServicesSubCat">
            ...
            <li>
              <label for="training">
                <input type="checkbox" id="training" class="humanServicesSubCat">
          ...
          <div class="collaspingSection">
            ...
            <div class="collapse" id="marylandCollapse">
              <ul class="list-unstyled normal">
                <li>
                  <label for="md-1">
                    <input type="checkbox" id="md-1" class="areasSubCat">
                    area 1 (
                ...
                <li>
                  <label for="md-2">
                    <input type="checkbox" id="md-2" class="areasSubCat">
                    area 2 (
          ...
          <div class="collaspingSection">
            ...
            <div class="collapse" id="virginiaCollapse">
              <ul class="list-unstyled normal">
                <li>
                  <label for="va-1">
                    <input type="checkbox" id="va-1" class="areasSubCat">
                    area 1 (
                ...
                <li>
                  <label for="va-2">
                    <input type="checkbox" id="va-2" class="areasSubCat">
                    area 2 (
            ...
            <div class="collaspingSection">
              ...
              <div class="collapse" id="dcCollapse">
                <ul class="list-unstyled normal">
                  <li>
                    <label for="dc-1">
                      <input type="checkbox" id="dc-1" class="areasSubCat">
                      area 1 (
                  ...
                  <li>
                    <label for="dc-2">
                      <input type="checkbox" id="dc-2" class="areasSubCat">
                      area 2 (
            ...
            <div class="collaspingSection">
              ...
              <div class="collapse" id="internationalCollapse">
                <ul class="list-unstyled normal">
                  <li>
                    <label for="int-1">
                      <input type="checkbox" id="int-1" class="areasSubCat">
                      area 1 (
                  ...
                  <li>
                    <label for="int-2">
                      <input type="checkbox" id="int-2" class="areasSubCat">
                      area 2 (
      ...
      <div>
        ...
        <div class="collapse selections" id="populationsServed">
          ...
          <ul class="list-unstyled normal">
            <li>
              <label for="infants">
                <input type="checkbox" id="infants" class="popsSubCat">
                Infants &amp; Children (
                <span class="arts-count">
                  3
                </span>
            ...
            <li>
              <label for="teens">
                <input type="checkbox" id="teens" class="popsSubCat">
                Youth Age 6 to 15
                <span class="sr-only">
                  years old
                </span>
            ...
            <li>
              <label for="adults">
                <input type="checkbox" id="adults" class="popsSubCat">
                Adults (
                <span class="kid-art-count">
                  4
                </span>
            ...
            <li>
              <label for="elderly">
                <input type="checkbox" id="elderly" class="popsSubCat">
                Elderly (
                <span class="arts-count">
                  3
                </span>
    ...
    <section class="col-xs-12 col-sm-9">
      <div class="row search-list-view">
        <ul class="list-inline search-list-jumplinks col-xs-12">
          <li>
            <a class="jumplink" href="javascript:void(0)" data-target="#letter-a">A</a>
          </li>
          <li>
            <a class="jumplink" href="javascript:void(0)" data-target="#letter-b">B</a>
          </li>
          <li>
            <a class="jumplink" href="javascript:void(0)" data-target="#letter-c">C</a>
          </li>
          <li>
            <a class="jumplink" href="javascript:void(0)" data-target="#letter-d">D</a>
          </li>
          <li>
            <a class="jumplink" href="javascript:void(0)" data-target="#letter-e">E</a>
          </li>
          <li>
            <a class="jumplink" href="javascript:void(0)" data-target="#letter-f">F</a>
          </li>
          <li>
            <a class="jumplink" href="javascript:void(0)" data-target="#letter-g">G</a>
          </li>
          <li>
            <a class="jumplink" href="javascript:void(0)" data-target="#letter-h">H</a>
          </li>
          <li>
            <a class="jumplink" href="javascript:void(0)" data-target="#letter-i">I</a>
          </li>
          <li>
            <a class="jumplink" href="javascript:void(0)" data-target="#letter-j">J</a>
          </li>
          <li>
            <a class="jumplink" href="javascript:void(0)" data-target="#letter-k">K</a>
          </li>
          <li>
            <a class="jumplink" href="javascript:void(0)" data-target="#letter-l">L</a>
          </li>
          <li>
            <a class="jumplink" href="javascript:void(0)" data-target="#letter-m">M</a>
          </li>
          <li>
            <a class="jumplink" href="javascript:void(0)" data-target="#letter-n">N</a>
          </li>
          <li>
            <a class="jumplink" href="javascript:void(0)" data-target="#letter-o">O</a>
          </li>
          <li>
            <a class="jumplink" href="javascript:void(0)" data-target="#letter-p">P</a>
          </li>
          <li>
            <a class="jumplink" href="javascript:void(0)" data-target="#letter-q">Q</a>
          </li>
          <li>
            <a class="jumplink" href="javascript:void(0)" data-target="#letter-r">R</a>
          </li>
          <li>
            <a class="jumplink" href="javascript:void(0)" data-target="#letter-s">S</a>
          </li>
          <li>
            <a class="jumplink" href="javascript:void(0)" data-target="#letter-t">T</a>
          </li>
          <li>
            <a class="jumplink" href="javascript:void(0)" data-target="#letter-u">U</a>
          </li>
          <li>
            <a class="jumplink" href="javascript:void(0)" data-target="#letter-v">V</a>
          </li>
          <li>
            <a class="jumplink" href="javascript:void(0)" data-target="#letter-x">X</a>
          </li>
          <li>
            <a class="jumplink" href="javascript:void(0)" data-target="#letter-y">Y</a>
          </li>
          <li>
            <a class="jumplink" href="javascript:void(0)" data-target="#letter-z">Z</a>
          </li>
          <li>
            <a class="jumplink" href="javascript:void(0)" data-target="#number-1">1</a>
          </li>
          <li>
            <a class="jumplink" href="javascript:void(0)" data-target="#number-2">2</a>
          </li>
          <li>
            <a class="jumplink" href="javascript:void(0)" data-target="#number-3">3</a>
          </li>
          <li>
            <a class="jumplink" href="javascript:void(0)" data-target="#number-4">4</a>
          </li>
          <li>
            <a class="jumplink" href="javascript:void(0)" data-target="#number-5">5</a>
          </li>
          <li>
            <a class="jumplink" href="javascript:void(0)" data-target="#number-6">6</a>
          </li>
          <li>
            <a class="jumplink" href="javascript:void(0)" data-target="#number-7">7</a>
          </li>
          <li>
            <a class="jumplink" href="javascript:void(0)" data-target="#number-8">8</a>
          </li>
          <li>
            <a class="jumplink" href="javascript:void(0)" data-target="#number-9">9</a>
          </li>
          <li>
        ...
        <div class="col-xs-12 nonprofit-list">
          ...
          <div class="media listing">
            ...
            <div class="media-body">
              <div class="clearfix">
                <h3 class="media-heading collapsed" data-toggle="collapse" aria-expanded="false">Alice Ferguson Foundation<br>
                  <small>Accokeek, MD</small></h3>
              </div>
              <div class="collapse content">
                <p>
                  Thanks to the Alice Ferguson Foundation, there’s a special place in Maryland where students from throughout the region can dig in the dirt, take a hike, and catch an unbeatable glimpse of the Potomac.
                </p>
                <p>
                  <a href="#" class="btn btn-primary" role="button">Learn More
                    <span class="sr-only">
                      about Alice Ferguson Foundation
                    </span>
                  </a> <a href="#" class="btn btn-secondary" role="button">Donate
                    <span class="sr-only">
                      to Alice Ferguson Foundation
                    </span>
                  </a>
                </p>
              </div>
          ...
          <div class="media listing">
            ...
            <div class="media-body">
              <div class="clearfix">
                <h3 class="media-heading collapsed" data-toggle="collapse" aria-expanded="false">Beacon House<br>
                  <small>Washington, DC</small></h3>
              </div>
              <div class="collapse content">
                <p>
                  Operating in the middle of a large, subsidized housing project in Ward 5 where students typically perform in the lowest quartile on standardized tests, Beacon House creates a culture of self-discipline and academic success for its children.
                </p>
                <p>
                  <a href="#" class="btn btn-primary" role="button">Learn More
                    <span class="sr-only">
          ...
          <div class="media listing">
            ...
            <div class="media-body">
              <div class="clearfix">
                <h3 class="media-heading collapsed" data-toggle="collapse" aria-expanded="false">Capital Partners for Education<br>
                  <small>Washington, DC</small></h3>
              </div>
              <div class="collapse content">
                <p>
                ...
                <p>
                  <a href="#" class="btn btn-primary" role="button">Learn More
                    ...
                    <span class="sr-only">
                      to Capital Partners for Education
                    </span>
                  </a>
                </p>
              </div>
