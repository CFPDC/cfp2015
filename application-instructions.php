	...
	<section class="col-xs-12 col-sm-8">
		...
		<div class="row">
			...
			<div class="col-xs-12">
				...
				<ul class="normal">
					<li>Work with CFP staff in May and June to approve written content and provide photos or other imagery for your Catalogue feature;</li>
					<li>Meet the rest of the Catalogue network and learn how to make the most of this partnership, by attending our “Best Practices” workshop in the fall and our launch event;</li>
					<li>Help us track our impact, by reporting Catalogue-inspired donations made to you throughout the years that you are featured in print and online;</li>
					<li>Bring your Catalogue webpage to life by uploading information about your <a href="happenings.php">events</a>, <a href="all-news.php">recent press hits</a>, <a href="volunteer.php">volunteer opportunities</a>, and impact throughout the year;</li>
					<li>Spread the word, by using the Catalogue's co-branding materials, especially the "One of the Best" stamp, on your homepage, stationery, newsletters, and email signatures.</li>
				</ul>
			</div>
			<div class="col-xs-12">
				<h3>Eligibility</h3>
				<p>In order to apply for the 2015/16 Catalogue, organizations must:</p>
				<ul class=" normal">
					<li>Be a registered 501(c)(3) charitable organization</li>
					<li>Have an operating budget between $100,000 and $3 million (previously featured organizations that have grown beyond our $3 million limit may reapply but, if successful, will be featured on the web only)</li>
					<li>Serve the people and communities of the greater Washington region &amp; have headquarters locally OR, if international, have headquarters in the greater Washington region (District of Columbia, Maryland: Montgomery County, Prince George's County, Frederick County;Virginia: Arlington County, Fairfax County, Loudoun County, Prince William County, City of Alexandria, City of Fairfax, City of Falls Church)
