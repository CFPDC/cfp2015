  ...
  <aside class="col-xs-12 col-sm-3" id="asideFilter">
    ...
    <div>
      ...
      <div class="collapse selections" id="natureSearch">
        <button class="btn btn-link select-all" data-list="natureSubCat" data-paramName="strCategory-nature" data-paramValue="nature">Select All</button>
        <ul class="list-unstyled normal">
          <li>
            <label for="animals">
              <input type="checkbox" id="animals" class="natureSubCat filter-parameter" data-paramName="strCategory-nature" data-paramValue="nature-animals"> Animals (<span class="environ-count">4</span>)
            </label>
          </li>
          <li>
            <label for="environment">
              <input type="checkbox" id="environment" class="natureSubCat filter-parameter" data-paramName="strCategory-nature" data-paramValue="nature-environment"> Environment (<span class="environ-count">3</span>)
            </label>
          </li>
        </ul>
      </div>
    ...
    <div>
      ...
      <div class="collapse selections" id="cultureSearch">
        <button class="btn btn-link select-all" data-list="cultureSubCat" data-paramName="strCategory-culture" data-paramValue="culture">Select All</button>
        <ul class="list-unstyled normal">
          <li>
            <label for="kid-art">
              <input type="checkbox" id="kid-art" class="cultureSubCat filter-parameter" data-paramName="strCategory-culture" data-paramValue="culture-community-arts"> Community Arts/Arts for Kids (<span class="kid-art-count">4</span>)
            </label>
          </li>
          <li>
            <label for="arts">
              <input type="checkbox" id="arts" class="cultureSubCat filter-parameter" data-paramName="strCategory-culture" data-paramValue="culture-arts-culture"> Arts &amp; Culture (<span class="arts-count">3</span>)
            </label>
          </li>
        </ul>
      </div>
    ...
    <div>
      ...
      <div class="collapse selections" id="educationSearch">
        <button class="btn btn-link select-all" data-list="educationSubCat" data-paramName="strCategory-education" data-paramValue="education">Select All</button>
        <ul class="list-unstyled normal">
          <li>
            <label for="enrichment">
              <input type="checkbox" id="enrichment" class="educationSubCat filter-parameter" data-paramName="strCategory-education" data-paramValue="education-enrichment"> Educational Enrichment (<span class="kid-art-count">4</span>)
            </label>
          </li>
          <li>
            <label for="literacy">
              <input type="checkbox" id="literacy" class="educationSubCat filter-parameter" data-paramName="strCategory-education" data-paramValue="education-literacy"> Literacy &amp; Learning (<span class="arts-count">3</span>)
            </label>
          </li>
          <li>
            <label for="schools">
              <input type="checkbox" id="schools" class="educationSubCat filter-parameter" data-paramName="strCategory-education" data-paramValue="education-schools"> Schools (<span class="arts-count">3</span>)
            </label>
          </li>
        </ul>
      </div>
    ...
    <div>
      ...
      <div class="collapse selections" id="humanServicesSearch">
        <button class="btn btn-link select-all" data-list="humanServicesSubCat" data-paramName="strCategory-human-services" data-paramValue="human-services">Select All</button>
        <ul class="list-unstyled normal">
          <li>
            <label for="Aging">
              <input type="checkbox" id="Aging" class="humanServicesSubCat filter-parameter" data-paramName="strCategory-human-services" data-paramValue="human-services-aging"> Aging (<span class="kid-art-count">4</span>)
            </label>
          </li>
          <li>
            <label for="families">
              <input type="checkbox" id="families" class="humanServicesSubCat filter-parameter" data-paramName="strCategory-human-services" data-paramValue="human-services-children-youth"> Children&sbquo; Youth &amp; Families (<span class="arts-count">3</span>)
            </label>
          </li>
          <li>
            <label for="commDev">
              <input type="checkbox" id="commDev" class="humanServicesSubCat filter-parameter" data-paramName="strCategory-human-services" data-paramValue="human-services-community-development"> Community Development (<span class="arts-count">3</span>)
            </label>
          </li>
          <li>
            <label for="women">
              <input type="checkbox" id="women" class="humanServicesSubCat filter-parameter" data-paramName="strCategory-human-services" data-paramValue="human-services-girls-women"> Girls &amp; Women (<span class="kid-art-count">4</span>)
            </label>
          </li>
          <li>
            <label for="health">
              <input type="checkbox" id="health" class="humanServicesSubCat filter-parameter" data-paramName="strCategory-human-services" data-paramValue="human-services-health"> Health &amp; Mental Health (<span class="arts-count">3</span>)
            </label>
          </li>
          <li>
            <label for="housing">
              <input type="checkbox" id="housing" class="humanServicesSubCat filter-parameter" data-paramName="strCategory-human-services" data-paramValue="human-services-homelessness"> Homelessness &amp; Housing (<span class="arts-count">3</span>)
            </label>
          </li>
          <li>
            <label for="hunger">
              <input type="checkbox" id="hunger" class="humanServicesSubCat filter-parameter" data-paramName="strCategory-human-services" data-paramValue="human-services-hunger"> Hunger (<span class="kid-art-count">4</span>)
            </label>
          </li>
          <li>
            <label for="justice">
              <input type="checkbox" id="justice" class="humanServicesSubCat filter-parameter" data-paramName="strCategory-human-services" data-paramValue="human-services-legal"> Legal &amp; Justice Programs (<span class="arts-count">3</span>)
            </label>
          </li>
          <li>
            <label for="training">
              <input type="checkbox" id="training" class="humanServicesSubCat filter-parameter" data-paramName="strCategory-human-services" data-paramValue="human-services-life-skills"> Life Skills&sbquo; Training &amp; Employment (<span class="arts-count">3</span>)
            </label>
          </li>
        </ul>
      </div>
    ...
    <div>
      ...
      <div class="collapse selections" id="areasServed">
        <button class="btn btn-link select-all" data-list="areasSubCat" data-paramName="strCategory-areas" data-paramValue="areas-served">Select All</button>
        <div class="collaspingSection">
          ...
          <div class="collapse" id="marylandCollapse">
            <ul class="list-unstyled normal">
              <li>
                <label for="md-1">
                  <input type="checkbox" id="md-1" class="areasSubCat filter-parameter" data-paramName="strCategory-areas" data-paramValue="md-"> area 1 (<span class="md-1-count">4</span>)
                </label>
              </li>
              <li>
                <label for="md-2">
                  <input type="checkbox" id="md-2" class="areasSubCat filter-parameter" data-paramName="strCategory-areas" data-paramValue="md-"> area 2 (<span class="md-2-count">3</span>)
                </label>
              </li>
            </ul>
          </div>
        ...
        <div class="collaspingSection">
          ...
          <div class="collapse" id="virginiaCollapse">
            <ul class="list-unstyled normal">
              <li>
                <label for="va-1">
                  <input type="checkbox" id="va-1" class="areasSubCat filter-parameter" data-paramName="strCategory-areas" data-paramValue="va-"> area 1 (<span class="va-1-count">4</span>)
                </label>
              </li>
              <li>
                <label for="va-2">
                  <input type="checkbox" id="va-2" class="areasSubCat filter-parameter" data-paramName="strCategory-areas" data-paramValue="va-"> area 2 (<span class="va-2-count">3</span>)
                </label>
              </li>
            </ul>
          </div>
          ...
          <div class="collaspingSection">
            ...
            <div class="collapse" id="dcCollapse">
              <ul class="list-unstyled normal">
                <li>
                  <label for="dc-1">
                    <input type="checkbox" id="dc-1" class="areasSubCat filter-parameter" data-paramName="strCategory-areas" data-paramValue="dc-"> area 1 (<span class="cd-1-count">4</span>)
                  </label>
                </li>
                <li>
                  <label for="dc-2">
                    <input type="checkbox" id="dc-2" class="areasSubCat filter-parameter" data-paramName="strCategory-areas" data-paramValue="dc-"> area 2 (<span class="dc-2-count">3</span>)
                  </label>
                </li>
              </ul>
            </div>
          ...
          <div class="collaspingSection">
            ...
            <div class="collapse" id="internationalCollapse">
              <ul class="list-unstyled normal">
                <li>
                  <label for="int-1">
                    <input type="checkbox" id="int-1" class="areasSubCat filter-parameter" data-paramName="strCategory-areas" data-paramValue="int-"> area 1 (<span class="int-1-count">4</span>)
                  </label>
                </li>
                <li>
                  <label for="int-2">
                    <input type="checkbox" id="int-2" class="areasSubCat filter-parameter" data-paramName="strCategory-areas" data-paramValue="int-"> area 2 (<span class="int-2-count">3</span>)
                  </label>
                </li>
              </ul>
            </div>
    ...
    <div>
      ...
      <div class="collapse selections" id="populationsServed">
        <button class="btn btn-link select-all" data-list="popsSubCat" data-paramName="strCategory-population" data-paramValue="pop-served">Select All</button>
        <ul class="list-unstyled normal">
          <li>
            <label for="infants">
              <input type="checkbox" id="infants" class="popsSubCat filter-parameter" data-paramName="strCategory-population" data-paramValue="pop-served-infants"> Infants &amp; Children (<span class="arts-count">3</span>)
            </label>
          </li>
          <li>
            <label for="teens">
              <input type="checkbox" id="teens" class="popsSubCat filter-parameter" data-paramName="strCategory-population" data-paramValue="pop-served-kids"> Youth Age 6 to 15 <span class="sr-only">years old</span> (<span class="arts-count">3</span>)
            </label>
          </li>
          <li>
            <label for="adults">
              <input type="checkbox" id="adults" class="popsSubCat filter-parameter" data-paramName="strCategory-population" data-paramValue="pop-served-adults"> Adults (<span class="kid-art-count">4</span>)
            </label>
          </li>
          <li>
            <label for="elderly">
              <input type="checkbox" id="elderly" class="popsSubCat filter-parameter" data-paramName="strCategory-population" data-paramValue="pop-served-elderly"> Elderly (<span class="arts-count">3</span>)
            </label>
          </li>
        </ul>
      </div>
        ...
        <div class="thumbnail">
          ...
          <div class="caption">
            ...
            <div class="bottom-align">
              <p><a href="#" class="btn btn-primary learn-more" role="button">Learn More</a> <a href="checkout.php" class="btn btn-secondary donate-nonprofit" role="button">Donate</a></p>
      ...
      <div class="col-xs-12 iso-item nonprofit-listing" data-year="2010" data-region="DC" data-category="culture">
        <div class="thumbnail">
          ...
          <div class="caption">
            ...
            <div class="bottom-align">
              <p><a href="#" class="btn btn-primary learn-more" role="button">Learn More</a> <a href="donate.php" class="btn btn-secondary donate-nonprofit" role="button">Donate</a></p>
              <p><small>Culture</small></p>
            </div>
          </div>
        </div>
      ...
      <div class="col-xs-12 iso-item nonprofit-listing" data-year="2014" data-region="DC" data-category="education">
        <div class="thumbnail">
          ...
          <div class="caption">
            ...
            <div class="bottom-align">
              <p><a href="commit.php?test=123" class="btn btn-primary learn-more" role="button">Learn More</a> <a href="checkout.php" class="btn btn-secondary donate-nonprofit" role="button">Donate</a></p>
              <p><small>Education</small></p>
            </div>
          </div>
        </div>
