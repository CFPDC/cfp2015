	...
	<section class="col-xs-12 col-sm-9">
		<div class="row">
			...
			<div class="col-xs-12 col-sm-3 pull-right">
				<img class="vision-image img-responsive" src="/resources/images/vision/transform-clear.png">
			</div>
