...
<div class="row">
	<aside class="col-xs-12 col-sm-3 who-we-are-nav" id="asideFilter" role="navigation">
		<ul class="list-unstyled">
			...
			<li>
				<a href="javascript:void(0);" class="current">Vision Report</a>
			</li>
		</ul>
	</aside>
	<section class="col-xs-12 col-sm-8">
		<div class="row">
			...
			At the Catalogue for Philanthropy, we are agents for change, dedicated to the following goals. We will:
			</p>
		</div>
