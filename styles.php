  ...
  <div class="bs-docs-section row">
    <div class="col-sm-3 push-down" role="complementary">
      <nav class="bs-docs-sidebar hidden-print hidden-xs hidden-sm affix">
        <ul class="nav bs-docs-sidenav normal">
          <li>
        ...
        <a class="back-to-top jump-link" href="#top"> Back to top </a>
      </nav>
    </div>
    <div class="col-md-9 style-guide-container">
      <div class="clearfix">
        ...
        <div class="highlight">
          <pre><code class="language-scss" data-lang="scss"><span class="cm">/* Extra small devices (phones, less than 768px) */</span>
...
<span class="k">@media</span> <span class="o">(</span><span class="nt">min-width</span><span class="nd">:</span> <span class="o">@</span><span class="nt">screen-lg-min</span><span class="o">)</span> <span class="p">{</span> <span class="nc">...</span> <span class="p">}</span>
        ...
        <div class="highlight">
          <pre><code class="language-scss" data-lang="scss"><span class="k">@media</span> <span class="o">(</span><span class="nt">max-width</span><span class="nd">:</span> <span class="o">@</span><span class="nt">screen-xs-max</span><span class="o">)</span> <span class="p">{</span> <span class="nc">...</span> <span class="p">}</span>
...
<span class="k">@media</span> <span class="o">(</span><span class="nt">min-width</span><span class="nd">:</span> <span class="o">@</span><span class="nt">screen-lg-min</span><span class="o">)</span> <span class="p">{</span> <span class="nc">...</span> <span class="p">}</span>
        ...
        <div class="col-xs-12 zero-clipboard">
          <span class="btn-clipboard">
          Copy
          </span>
        </div>
...
<span class="nt">&lt;/div&gt;</span>
        ...
        <h33 id="grid-example-mixed">
        <a class="anchorjs-link " href="#grid-example-mixed" aria-label="Anchor link for: grid example mixed" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Example: Mobile and desktop
        </h3>
        <p>
        ...
        <div class="col-xs-12 highlight">
          <pre><code class="language-html" data-lang="html"><span class="c">&lt;!-- Stack the columns on mobile by making one full-width and the other half-width --&gt;</span>
<span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"row"</span><span class="nt">&gt;</span>
...
<span class="nt">&lt;/div&gt;</span>
        ...
        <div class="zero-clipboard clearfix">
          <span class="btn-clipboard">
          Copy
          </span>
        </div>
...
<span class="nt">&lt;/div&gt;</span>
        ...
        <div class="highlight">
          <pre><code class="language-scss" data-lang="scss"><span class="k">@grid-columns</span><span class="nd">:</span>              <span class="nt">12</span><span class="p">;</span>
<span class="k">@grid-gutter-width</span><span class="nd">:</span>         <span class="nt">30px</span><span class="p">;</span>
<span class="k">@grid-float-breakpoint</span><span class="nd">:</span>     <span class="nt">768px</span><span class="p">;</span>
</code></pre>
        </div>
...
<span class="p">}</span>
        ...
        <div class="highlight">
          <pre><code class="language-scss" data-lang="scss"><span class="nc">.wrapper</span> <span class="p">{</span>
...
<span class="p">}</span>
        ...
        <div class="highlight">
          <pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"wrapper"</span><span class="nt">&gt;</span>
...
<span class="nt">&lt;/div&gt;</span>
        ...
        <h2 id="colors"> <a class="anchorjs-link jump-link" href="#colors" aria-label="Anchor link for: type" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a> Colors </h2>
        <p>
      ...
      <h2 id="type"> <a class="anchorjs-link jump-link" href="#type" aria-label="Anchor link for: type" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a> Typography </h2>
      <!-- Headings -->
      <h3 id="type-headings"><a class="anchorjs-link jump-link" href="#type-headings" aria-label="Anchor link for: type headings" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Headings</h3>
      <p>
      ...
      <div class="bs-example bs-example-type" data-example-id="simple-headings">
        <table class="table">
          <tbody>
            ...
            <tr>
              <td><h5>h5. heading<strong> (currently not used)</strong></h5></td>
              <td class="type-info">Proxima Nova Regular</td>
            </tr>
            <tr>
              <td><h6>h6. heading <strong>(currently not used)</strong></h6></td>
              <td class="type-info">Proxima Nova Regular</td>
            </tr>
          </tbody>
        </table>
...
<span class="nt">&lt;h6&gt;</span>h6. heading<span class="nt">&lt;/h6&gt;</span>
      ...
      <!-- Body copy -->
      <h3 id="type-body-copy"><a class="anchorjs-link jump-link" href="#type-body-copy" aria-label="Anchor link for: type body copy" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Body copy</h3>
      <p>
      ...
      <!-- Body copy .lead -->
      <h4 id="lead-body-copy"><a class="anchorjs-link jump-link" href="#lead-body-copy" aria-label="Anchor link for: lead body copy" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Lead body copy</h4>
      ...
      <!-- Using Less -->
      <h3 id="built-with-less"><a class="anchorjs-link jump-link" href="#built-with-less" aria-label="Anchor link for: built with less" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Built with Less</h3>
      <p>
      The typographic scale is based on two Less variables in <strong>variables.less</strong>: <code>@font-size-base</code> and <code>@line-height-base</code>. The first is the base font-size used throughout and the second is the base line-height. We use those variables and some simple math to create the margins, paddings, and line-heights of all our type and more. Customize them and Bootstrap adapts.
      </p>
      <!-- Inline text elements -->
      <h2 id="type-inline-text"><a class="anchorjs-link jump-link" href="#type-inline-text" aria-label="Anchor link for: type inline text" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Inline text elements</h2>
      <h3 id="marked-text"><a class="anchorjs-link jump-link" href="#marked-text" aria-label="Anchor link for: marked text" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Marked text</h3>
      <p>
...
<pre><code class="language-html" data-lang="html">You can use the mark tag to <span class="nt">&lt;mark&gt;</span>highlight<span class="nt">&lt;/mark&gt;</span> text.</code></pre>
      ...
      <h3 id="deleted-text"><a class="anchorjs-link jump-link" href="#deleted-text" aria-label="Anchor link for: deleted text" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Deleted text</h3>
<p>
...
Copy
      ...
      <h3 id="inserted-text"><a class="anchorjs-link jump-link" href="#inserted-text" aria-label="Anchor link for: inserted text" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Inserted text</h3>
      <p>
      ...
      <h3 id="underlined-text"><a class="anchorjs-link jump-link" href="#underlined-text" aria-label="Anchor link for: underlined text" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Underlined text</h3>
      <p>
      ...
      <h3 id="small-text"><a class="anchorjs-link jump-link" href="#small-text" aria-label="Anchor link for: small text" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Small text</h3>
      <p>
      ...
      <h3 id="bold"><a class="anchorjs-link jump-link" href="#bold" aria-label="Anchor link for: bold" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Bold</h3>
      <p>
      ...
      <h3 id="italics"><a class="anchorjs-link jump-link" href="#italics" aria-label="Anchor link for: italics" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Italics</h3>
      <p>
      ...
      <h2 id="type-alignment"><a class="anchorjs-link jump-link" href="#type-alignment" aria-label="Anchor link for: type alignment" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Alignment classes</h2>
      <p>
...
<span class="nt">&lt;p</span> <span class="na">class=</span><span class="s">"text-nowrap"</span><span class="nt">&gt;</span>No wrap text.<span class="nt">&lt;/p&gt;</span>
      ...
      <h2 id="type-transformation"><a class="anchorjs-link jump-link" href="#type-transformation" aria-label="Anchor link for: type transformation" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Transformation classes</h2>
      <p>
...
<span class="nt">&lt;p</span> <span class="na">class=</span><span class="s">"text-capitalize"</span><span class="nt">&gt;</span>Capitalized text.<span class="nt">&lt;/p&gt;</span>
      ...
      <!-- Abbreviations -->
      <h2 id="type-abbreviations"><a class="anchorjs-link jump-link" href="#type-abbreviations" aria-label="Anchor link for: type abbreviations" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Abbreviations</h2>
      <p>
      ...
      <h3 id="basic-abbreviation"><a class="anchorjs-link jump-link" href="#basic-abbreviation" aria-label="Anchor link for: basic abbreviation" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Basic abbreviation</h3>
    ...
    <h3 id="initialism"><a class="anchorjs-link jump-link" href="#initialism" aria-label="Anchor link for: initialism" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Initialism</h3>
    <p>
  ...
  <!-- Addresses -->
  <h2 id="type-addresses"><a class="anchorjs-link jump-link" href="#type-addresses" aria-label="Anchor link for: type addresses" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Addresses</h2>
  <p>
...
<!-- Blockquotes -->
<h2 id="type-blockquotes"><a class="anchorjs-link jump-link" href="#type-blockquotes" aria-label="Anchor link for: type blockquotes" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Blockquotes</h2>
<p>
For quoting blocks of content from another source within your document.
</p>
<h3 id="default-blockquote"><a class="anchorjs-link jump-link" href="#default-blockquote" aria-label="Anchor link for: default blockquote" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Default blockquote</h3>
<p>
...
<h4 id="alternate-displays"><a class="anchorjs-link jump-link" href="#alternate-displays" aria-label="Anchor link for: alternate displays" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Alternate displays</h4>
<p>
...
<!-- Lists -->
<h2 id="type-lists"><a class="anchorjs-link jump-link" href="#type-lists" aria-label="Anchor link for: type lists" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Lists</h2>
<h3 id="unordered"><a class="anchorjs-link jump-link" href="#unordered" aria-label="Anchor link for: unordered" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Unordered</h3>
<p>
...
<h3 id="ordered"><a class="anchorjs-link jump-link" href="#ordered" aria-label="Anchor link for: ordered" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Ordered</h3>
<p>
...
<h3 id="unstyled"><a class="anchorjs-link jump-link" href="#unstyled" aria-label="Anchor link for: unstyled" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Unstyled</h3>
<p>
...
<h3 id="inline"><a class="anchorjs-link jump-link" href="#inline" aria-label="Anchor link for: inline" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Inline</h3>
<p>
...
<h3 id="description"><a class="anchorjs-link jump-link" href="#description" aria-label="Anchor link for: description" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Description</h3>
<p>
...
<h4 id="horizontal-description"><a class="anchorjs-link jump-link" href="#horizontal-description" aria-label="Anchor link for: horizontal description" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Horizontal description</h4>
<p>
...
</div><!-- headers already changed down from here -->
<!-- begin code section -->
<h2 id="code" class="page-header"><a class="anchorjs-link " href="#code" aria-label="Anchor link for: code" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Code</h2>
<h3 id="code-inline"><a class="anchorjs-link " href="#code-inline" aria-label="Anchor link for: code inline" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Inline</h3>
...
<h3 id="code-user-input"><a class="anchorjs-link " href="#code-user-input" aria-label="Anchor link for: code user input" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>User input</h3>
...
<h3 id="code-block"><a class="anchorjs-link " href="#code-block" aria-label="Anchor link for: code block" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Basic block</h3>
...
<h3 id="code-variables"><a class="anchorjs-link " href="#code-variables" aria-label="Anchor link for: code variables" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Variables</h3>
...
<h3 id="code-sample-output"><a class="anchorjs-link " href="#code-sample-output" aria-label="Anchor link for: code sample output" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Sample output</h3>
...
<!-- end code section -->
<h2 id="tables"><a class="anchorjs-link " href="#tables" aria-label="Anchor link for: tables" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Tables</h2>
<h3 id="tables-example"><a class="anchorjs-link " href="#tables-example" aria-label="Anchor link for: tables example" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Basic example</h2>
<p>
...
<h4 id="tables-striped"><a class="anchorjs-link " href="#tables-striped" aria-label="Anchor link for: tables striped" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Striped rows</h4>
<p>
...
<p>
Striped tables are styled via the <code>:nth-child</code> CSS selector, which is not available in Internet Explorer 8.
</p>
</div>
...
<h4 id="tables-bordered"><a class="anchorjs-link " href="#tables-bordered" aria-label="Anchor link for: tables bordered" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Bordered table</h4>
<p>
...
<div class="highlight">
        <pre><code class="language-html" data-lang="html"><span class="nt">&lt;table</span> <span class="na">class=</span><span class="s">"table table-bordered"</span><span class="nt">&gt;</span>
  ...
<span class="nt">&lt;/table&gt;</span>
</code></pre>
</div>
<h3 id="tables-hover-rows"><a class="anchorjs-link " href="#tables-hover-rows" aria-label="Anchor link for: tables hover rows" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Hover rows</h3>
<p>
...
<div class="highlight">
        <pre><code class="language-html" data-lang="html"><span class="nt">&lt;table</span> <span class="na">class=</span><span class="s">"table table-hover"</span><span class="nt">&gt;</span>
  ...
<span class="nt">&lt;/table&gt;</span>
</code></pre>
</div>
<h3 id="tables-condensed"><a class="anchorjs-link " href="#tables-condensed" aria-label="Anchor link for: tables condensed" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Condensed table</h3>
<p>
...
<div class="highlight">
        <pre><code class="language-html" data-lang="html"><span class="c">&lt;!-- On rows --&gt;</span>
...
<h3 id="tables-responsive"><a class="anchorjs-link " href="#tables-responsive" aria-label="Anchor link for: tables responsive" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Responsive tables</h3>
<p>
...
<p>
Responsive tables make use of <code>overflow-y: hidden</code>, which clips off any content that goes beyond the bottom or top edges of the table. In particular, this can clip off dropdown menus and other third-party widgets.
</p>
</div>
<div class="bs-callout bs-callout-warning" id="callout-tables-responsive-ff-fieldset">
<h5>Firefox and fieldsets</h5>
<p>
Firefox has some awkward fieldset styling involving <code>width</code> that interferes with the responsive table. This cannot be overriden without a Firefox-specific hack that we <strong>don't</strong> provide in Bootstrap:
</p>
<div class="zero-clipboard">
  <span class="btn-clipboard">
  Copy
...
<div class="highlight">
          <pre><code class="language-css" data-lang="css"><span class="k">@-moz-document</span> <span class="n">url-prefix</span><span class="p">()</span> <span class="p">{</span>
...
<p>
For more information, read <a href="https://stackoverflow.com/questions/17408815/fieldset-resizes-wrong-appears-to-have-unremovable-min-width-min-content/17863685#17863685">this Stack Overflow answer</a>.
</p>
</div>
...
<h2 id="forms" class="page-header"><a class="anchorjs-link " href="#forms" aria-label="Anchor link for: forms" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Forms</h2>
<h3 id="forms-example"><a class="anchorjs-link " href="#forms-example" aria-label="Anchor link for: forms example" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Basic example</h3>
...
<h3 id="forms-inline"><a class="anchorjs-link " href="#forms-inline" aria-label="Anchor link for: forms inline" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Inline form</h3>
...
<h5>May require custom widths</h5>
...
<span class="nt">&lt;/form&gt;</span></code></pre></div>
<h3 id="forms-horizontal"><a class="anchorjs-link " href="#forms-horizontal" aria-label="Anchor link for: forms horizontal" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Horizontal form</h3>
...
<form class="form-horizontal">
  ...
  <div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;form</span> <span class="na">class=</span><span class="s">"form-horizontal"</span><span class="nt">&gt;</span>
    ...
    <span class="nt">&lt;/div&gt;</span>
<span class="nt">&lt;/form&gt;</span></code></pre></div>
<h3 id="forms-controls"><a class="anchorjs-link " href="#forms-controls" aria-label="Anchor link for: forms controls" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Supported controls</h3>
<p>Examples of standard form controls supported in an example form layout.</p>
<h4 id="inputs"><a class="anchorjs-link " href="#inputs" aria-label="Anchor link for: inputs" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Inputs</h4>
<p>Most common form control, text-based input fields. Includes support for all HTML5 types: <code>text</code>, <code>password</code>, <code>datetime</code>, <code>datetime-local</code>, <code>date</code>, <code>month</code>, <code>time</code>, <code>week</code>, <code>number</code>, <code>email</code>, <code>url</code>, <code>search</code>, <code>tel</code>, and <code>color</code>.</p>
<div class="bs-callout bs-callout-danger" id="callout-input-needs-type">
<h5>Type declaration required</h5>
...
<h4 id="textarea"><a class="anchorjs-link " href="#textarea" aria-label="Anchor link for: textarea" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Textarea</h4>
...
<div class="bs-example" data-example-id="textarea-form-control">
  ...
  <h4 id="checkboxes-and-radios"><a class="anchorjs-link " href="#checkboxes-and-radios" aria-label="Anchor link for: checkboxes and radios" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Checkboxes and radios</h4>
  ...
  <h5 id="default-stacked"><a class="anchorjs-link " href="#default-stacked" aria-label="Anchor link for: default stacked" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Default (stacked)</h5>
  ...
  <h5 id="inline-checkboxes-and-radios"><a class="anchorjs-link " href="#inline-checkboxes-and-radios" aria-label="Anchor link for: inline checkboxes and radios" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Inline checkboxes and radios</h5>
  ...
  <h5 id="checkboxes-and-radios-without-la"><a class="anchorjs-link " href="#checkboxes-and-radios-without-la" aria-label="Anchor link for: checkboxes and radios without la" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Checkboxes and radios without label text</h5>
  ...
  <div class="bs-example" data-example-id="checkboxes-radios-without-labels">
    <form>
      ...
      <span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"radio"</span><span class="nt">&gt;</span>
        ...
        <span class="nt">&lt;/label&gt;</span>
<span class="nt">&lt;/div&gt;</span></code></pre></div>
<h4 id="selects"><a class="anchorjs-link " href="#selects" aria-label="Anchor link for: selects" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Selects</h4>
...
<span class="nt">&lt;/form&gt;</span></code></pre></div>
<h3 id="forms-control-focus"><a class="anchorjs-link " href="#forms-control-focus" aria-label="Anchor link for: forms control focus" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Focus state</h3>
...
<h5>Demo <code>:focus</code> state</h5>
...
<div class="bs-example" data-example-id="readonly-text-form-control">
  ...
  <div class="bs-callout bs-callout-warning" id="callout-form-validation-state-accessibility">
    <h5>Conveying validation state to assistive technologies and colorblind users</h5>
      ...
      <div class="has-error">
        <div class="checkbox">
          ...
          <span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"has-error"</span><span class="nt">&gt;</span>
            ...
            <span class="nt">&lt;/div&gt;</span>
  <span class="nt">&lt;/div&gt;</span></code></pre></div>
  <h4 id="with-optional-icons"><a class="anchorjs-link " href="#with-optional-icons" aria-label="Anchor link for: with optional icons" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>With optional icons</h4>
  ...
  <div class="bs-callout bs-callout-warning" id="callout-has-feedback-icon-positioning">
    <h5>Icons, labels, and input groups</h5>
  ...
  <div class="bs-callout bs-callout-warning" id="callout-has-feedback-icon-accessibility">
    <h5>Conveying the icon's meaning to assistive technologies</h5>
...
<span class="nt">&lt;/div&gt;</span></code></pre></div>
<h5 id="optional-icons-in-horizontal-and"><a class="anchorjs-link " href="#optional-icons-in-horizontal-and" aria-label="Anchor link for: optional icons in horizontal and" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Optional icons in horizontal and inline forms</h5>
...
<span class="nt">&lt;form</span> <span class="na">class=</span><span class="s">"form-inline"</span><span class="nt">&gt;</span>
  ...
  <span class="nt">&lt;/div&gt;</span>
<span class="nt">&lt;/form&gt;</span></code></pre></div>
<h5 id="optional-icons-with-hidden-sr-on"><a class="anchorjs-link " href="#optional-icons-with-hidden-sr-on" aria-label="Anchor link for: optional icons with hidden sr on" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Optional icons with hidden <code>.sr-only</code> labels</h5>
...
<span class="nt">&lt;/div&gt;</span></code></pre></div>
<h3 id="forms-control-sizes"><a class="anchorjs-link " href="#forms-control-sizes" aria-label="Anchor link for: forms control sizes" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Control sizing</h3>
<p>Set heights using classes like <code>.input-lg</code>, and set widths using grid column classes like <code>.col-lg-*</code>.</p>
<h4 id="height-sizing"><a class="anchorjs-link " href="#height-sizing" aria-label="Anchor link for: height sizing" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Height sizing</h4>
...
<h4 id="horizontal-form-group-sizes"><a class="anchorjs-link " href="#horizontal-form-group-sizes" aria-label="Anchor link for: horizontal form group sizes" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Horizontal form group sizes</h4>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;form</span> <span class="na">class=</span><span class="s">"form-horizontal"</span><span class="nt">&gt;</span>
  ...
  <span class="nt">&lt;/div&gt;</span>
<span class="nt">&lt;/form&gt;</span></code></pre></div>
<h4 id="column-sizing"><a class="anchorjs-link " href="#column-sizing" aria-label="Anchor link for: column sizing" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Column sizing</h4>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"row"</span><span class="nt">&gt;</span>
  ...
  <span class="nt">&lt;/div&gt;</span>
<span class="nt">&lt;/div&gt;</span></code></pre></div>
<h3 id="forms-help-text"><a class="anchorjs-link " href="#forms-help-text" aria-label="Anchor link for: forms help text" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Help text</h3>
...
<h2 id="buttons" class="page-header"><a class="anchorjs-link " href="#buttons" aria-label="Anchor link for: buttons" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Buttons</h2>
<h3 id="buttons-tags"><a class="anchorjs-link " href="#buttons-tags" aria-label="Anchor link for: buttons tags" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Button tags</h3>
...
<h3 id="buttons-options"><a class="anchorjs-link " href="#buttons-options" aria-label="Anchor link for: buttons options" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Options</h3>
...
<h3 id="buttons-active"><a class="anchorjs-link " href="#buttons-active" aria-label="Anchor link for: buttons active" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Active state</h3>
...
<h4 id="button-element"><a class="anchorjs-link " href="#button-element" aria-label="Anchor link for: button element" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Button element</h4>
...
<h4 id="anchor-element"><a class="anchorjs-link " href="#anchor-element" aria-label="Anchor link for: anchor element" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Anchor element</h4>
...
<h3 id="buttons-disabled"><a class="anchorjs-link " href="#buttons-disabled" aria-label="Anchor link for: buttons disabled" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Disabled state</h3>
<p>Make buttons look unclickable by fading them back with <code>opacity</code>.</p>
<h4 id="button-element-1"><a class="anchorjs-link " href="#button-element-1" aria-label="Anchor link for: button element 1" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Button element</h4>
...
<h4 id="anchor-element-1"><a class="anchorjs-link " href="#anchor-element-1" aria-label="Anchor link for: anchor element 1" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Anchor element</h4>
...
<h2 id="images" class="page-header"><a class="anchorjs-link " href="#images" aria-label="Anchor link for: images" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Images</h2>
<h3 id="images-responsive"><a class="anchorjs-link " href="#images-responsive" aria-label="Anchor link for: images responsive" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Responsive images</h3>
...
<p>To center images which use the <code>.img-responsive</code> class, use <code>.center-block</code> instead of <code>.text-center</code>. <a href="#helper-classes-center">See the helper classes section</a> for more details about <code>.center-block</code> usage.</p>
<div class="bs-callout bs-callout-warning" id="callout-images-ie-svg">
<h5>SVG images and IE 8-10</h5>
...
<h3 id="images-shapes"><a class="anchorjs-link " href="#images-shapes" aria-label="Anchor link for: images shapes" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Image shapes</h3>
...
<img data-src="holder.js/140x140" class="img-rounded" alt="140x140" style="width: 140px; height: 140px;" src="data:image/svg+xml;base64," data-holder-rendered="true">
<img data-src="holder.js/140x140" class="img-circle" alt="140x140" style="width: 140px; height: 140px;" src="data:image/svg+xml;base64," data-holder-rendered="true">
<img data-src="holder.js/140x140" class="img-thumbnail" alt="140x140" style="width: 140px; height: 140px;" src="data:image/svg+xml;base64," data-holder-rendered="true">
</div>
...
<h2 id="helper-classes" class="page-header"><a class="anchorjs-link " href="#helper-classes" aria-label="Anchor link for: helper classes" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Helper classes</h2>
<h4 id="helper-classes-colors"><a class="anchorjs-link " href="#helper-classes-colors" aria-label="Anchor link for: helper classes colors" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Contextual colors</h4>
...
<h4 id="helper-classes-backgrounds"><a class="anchorjs-link " href="#helper-classes-backgrounds" aria-label="Anchor link for: helper classes backgrounds" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Contextual backgrounds</h4>
...
<h4 id="helper-classes-close"><a class="anchorjs-link " href="#helper-classes-close" aria-label="Anchor link for: helper classes close" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Close icon</h4>
...
<h4 id="helper-classes-carets"><a class="anchorjs-link " href="#helper-classes-carets" aria-label="Anchor link for: helper classes carets" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Carets</h4>
...
<h4 id="helper-classes-floats"><a class="anchorjs-link " href="#helper-classes-floats" aria-label="Anchor link for: helper classes floats" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Quick floats</h4>
...
<h4 id="helper-classes-center"><a class="anchorjs-link " href="#helper-classes-center" aria-label="Anchor link for: helper classes center" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Center content blocks</h4>
...
<span class="p">}</span></code></pre></div>
<h4 id="helper-classes-clearfix"><a class="anchorjs-link " href="#helper-classes-clearfix" aria-label="Anchor link for: helper classes clearfix" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Clearfix</h4>
...
<span class="p">}</span></code></pre></div>
<h4 id="helper-classes-show-hide"><a class="anchorjs-link " href="#helper-classes-show-hide" aria-label="Anchor link for: helper classes show hide" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Showing and hiding content</h4>
...
<span class="p">}</span></code></pre></div>
<h4 id="helper-classes-screen-readers"><a class="anchorjs-link " href="#helper-classes-screen-readers" aria-label="Anchor link for: helper classes screen readers" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Screen reader and keyboard navigation content</h4>
...
<span class="p">}</span></code></pre></div>
<h4 id="helper-classes-image-replacement"><a class="anchorjs-link " href="#helper-classes-image-replacement" aria-label="Anchor link for: helper classes image replacement" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Image replacement</h4>
...
<h3 id="responsive-utilities-tests"><a class="anchorjs-link " href="#responsive-utilities-tests" aria-label="Anchor link for: responsive utilities tests" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Test cases</h3>
<p>Resize your browser or load on different devices to test the responsive utility classes.</p>
<h4 id="visible-on"><a class="anchorjs-link " href="#visible-on" aria-label="Anchor link for: visible on" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Visible on...</h4>
...
<h4 id="hidden-on"><a class="anchorjs-link " href="#hidden-on" aria-label="Anchor link for: hidden on" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Hidden on...</h4>
...
<!-- less section -->
<h2 id="less" class="page-header"><a class="anchorjs-link " href="#less" aria-label="Anchor link for: less" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Using Less</h2>
...
<h3 id="less-bootstrap"><a class="anchorjs-link " href="#less-bootstrap" aria-label="Anchor link for: less bootstrap" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Compiling Bootstrap</h3>
...
<h3 id="less-variables"><a class="anchorjs-link " href="#less-variables" aria-label="Anchor link for: less variables" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Variables</h3>
...
<h4 id="less-variables-colors"><a class="anchorjs-link " href="#less-variables-colors" aria-label="Anchor link for: less variables colors" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Colors</h4>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-scss" data-lang="scss"><span class="c1">// Use as-is
...
<span class="p">}</span></code></pre></div>
<h4 id="less-variables-scaffolding"><a class="anchorjs-link " href="#less-variables-scaffolding" aria-label="Anchor link for: less variables scaffolding" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Scaffolding</h4>
<p>A handful of variables for quickly customizing key elements of your site's skeleton.</p>
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-scss" data-lang="scss"><span class="c1">// Scaffolding
...
<h4 id="less-variables-links"><a class="anchorjs-link " href="#less-variables-links" aria-label="Anchor link for: less variables links" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Links</h4>
<p>Easily style your links with the right color with only one value.</p>
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-scss" data-lang="scss"><span class="c1">// Variables
...
<h4 id="less-variables-typography"><a class="anchorjs-link " href="#less-variables-typography" aria-label="Anchor link for: less variables typography" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Typography</h4>
...
<h4 id="less-variables-icons"><a class="anchorjs-link " href="#less-variables-icons" aria-label="Anchor link for: less variables icons" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Icons</h4>
...
<h4 id="less-variables-components"><a class="anchorjs-link " href="#less-variables-components" aria-label="Anchor link for: less variables components" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Components</h4>
...
<h3 id="less-mixins-vendor"><a class="anchorjs-link " href="#less-mixins-vendor" aria-label="Anchor link for: less mixins vendor" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Vendor mixins</h3>
...
<h4 id="less-mixins-box-sizing"><a class="anchorjs-link " href="#less-mixins-box-sizing" aria-label="Anchor link for: less mixins box sizing" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Box-sizing</h4>
...
<span class="p">}</span></code></pre></div>
<h4 id="less-mixins-rounded-corners"><a class="anchorjs-link " href="#less-mixins-rounded-corners" aria-label="Anchor link for: less mixins rounded corners" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Rounded corners</h4>
...
<span class="p">}</span></code></pre></div>
<h4 id="less-mixins-transformations"><a class="anchorjs-link " href="#less-mixins-transformations" aria-label="Anchor link for: less mixins transformations" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Transformations</h4>
...
<span class="p">}</span></code></pre></div>
<h4 id="less-mixins-animations"><a class="anchorjs-link " href="#less-mixins-animations" aria-label="Anchor link for: less mixins animations" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Animations</h4>
...
<span class="p">}</span></code></pre></div>
<h4 id="less-mixins-opacity"><a class="anchorjs-link " href="#less-mixins-opacity" aria-label="Anchor link for: less mixins opacity" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Opacity</h4>
...
<span class="p">}</span></code></pre></div>
<h4 id="less-mixins-placeholder"><a class="anchorjs-link " href="#less-mixins-placeholder" aria-label="Anchor link for: less mixins placeholder" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Placeholder text</h4>
...
<h4 id="less-mixins-columns"><a class="anchorjs-link " href="#less-mixins-columns" aria-label="Anchor link for: less mixins columns" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Columns</h4>
...
<span class="p">}</span></code></pre></div>
<h4 id="less-mixins-gradients"><a class="anchorjs-link " href="#less-mixins-gradients" aria-label="Anchor link for: less mixins gradients" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Gradients</h4>
...
<h3 id="less-mixins-utility"><a class="anchorjs-link " href="#less-mixins-utility" aria-label="Anchor link for: less mixins utility" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Utility mixins</h3>
<p>Utility mixins are mixins that combine otherwise unrelated CSS properties to achieve a specific goal or task.</p>
<h4 id="less-mixins-clearfix"><a class="anchorjs-link " href="#less-mixins-clearfix" aria-label="Anchor link for: less mixins clearfix" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Clearfix</h4>
...
<span class="c1">// Usage
  ...
  <span class="nc">.clearfix</span><span class="o">()</span><span class="p">;</span>
<span class="p">}</span></code></pre></div>
<h4 id="less-mixins-centering"><a class="anchorjs-link " href="#less-mixins-centering" aria-label="Anchor link for: less mixins centering" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Horizontal centering</h4>
...
<span class="c1">// Usage
  ...
  <span class="nc">.center-block</span><span class="o">()</span><span class="p">;</span>
<span class="p">}</span></code></pre></div>
<h4 id="less-mixins-sizing"><a class="anchorjs-link " href="#less-mixins-sizing" aria-label="Anchor link for: less mixins sizing" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Sizing helpers</h4>
...
<h4 id="less-mixins-resizable"><a class="anchorjs-link " href="#less-mixins-resizable" aria-label="Anchor link for: less mixins resizable" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Resizable textareas</h4>
...
<span class="p">}</span></code></pre></div>
<h4 id="less-mixins-truncating"><a class="anchorjs-link " href="#less-mixins-truncating" aria-label="Anchor link for: less mixins truncating" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Truncating text</h4>
...
<span class="p">}</span></code></pre></div>
<h4 id="less-mixins-retina-images"><a class="anchorjs-link " href="#less-mixins-retina-images" aria-label="Anchor link for: less mixins retina images" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Retina images</h4>
...
<!-- end of less section -->
<!-- begin sass section -->
<h2 id="sass" class="page-header"><a class="anchorjs-link " href="#sass" aria-label="Anchor link for: sass" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Using Sass</h2>
...
<h3 id="sass-contents"><a class="anchorjs-link " href="#sass-contents" aria-label="Anchor link for: sass contents" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>What's included</h3>
...
<h3 id="sass-installation"><a class="anchorjs-link " href="#sass-installation" aria-label="Anchor link for: sass installation" data-anchorjs-icon="" style="font-family: anchorjs-icons; font-style: normal; font-variant: normal; font-weight: normal; position: absolute; margin-left: -1em; padding-right: 0.5em;"></a>Installation</h3>
