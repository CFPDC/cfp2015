...
<div class="row">
	<section class="col-sm-8">
		...
		<form class="two-column-form comment-form col-lg-10" action="/cfpdc/blog.php?__blogfile=http://blog.cfp-dc.org/wp-comments-post.php" method="post" id="commentform">
			<div class="text-left">
				<h3>Leave a Reply</h3>
				<p>Your email address will not be published.</p>
			</div>
			<fieldset>
				<legend class="sr-only">Leave a reply to the article</legend>
				<div class="row">
					<div class="col-sm-6">
						<div class="two-line">
							<label for="author">Name<small> (required)</small></label>
							<input type="text" id="author" maxlength="40" name="author" aria-required="true">
						</div>
					</div>
					<div class="col-sm-6">
						<div class="two-line">
				...
				<div class="row">
					<div class="col-sm-6">
						<div class="two-line">
							...
							<input type="text" id="url" maxlength="40" name="url">
						</div>
					</div>
					<div class="col-sm-6">
						<div class="checkbox">
							<div>
								<label class="checkbox-label" for="subscribe_comments">
									<input type="checkbox" name="subscribe_comments" id="subscribe_comments" value="subscribe">
								Notify me of follow-up comments by email </label>
								<br>
								<label class="checkbox-label" for="subscribe_blog">
					...
					<div class="col-xs-12">
						<div class="comments">
							<label for="comment">Comments <small> (required) </small></label>
							<textarea class="form-control" id="comment" name="comment" rows="6" aria-describedby="tags-allowed" aria-required="true"></textarea>
						<p class="form-allowed-tags" id="tags-allowed">You may use these <abbr title="HyperText Markup Language">HTML</abbr> tags and attributes:
<pre style="max-width: 425px"><code>&lt;a href="" title=""&gt; &lt;abbr title=""&gt; &lt;acronym title=""&gt; &lt;b&gt; &lt;blockquote cite=""&gt; &lt;cite&gt; &lt;code&gt; &lt;del datetime=""&gt; &lt;em&gt; &lt;i&gt; &lt;q cite=""&gt; &lt;strike&gt; &lt;strong&gt;</code></pre></p>
					</div>
				</div>
				<div class="col-xs-12">
					<div class="submit-button">
						<input type="hidden" name="region" value="dc">
						<label class="sr-only" for="form-submit">Post your comment</label>
						<input type="submit" class="btn btn-primary" id="form-submit" value="Post Comment">
					</div>
				</div>
			</div>
		</fieldset>
