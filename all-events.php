...
<div class="row">
	...
	<section class="col-sm-8">
		<div class="row">
			...
			<div class="col-sm-4">
				<a href="#" class="btn btn-info all-event-button"><span class="fa fa-calendar" aria-hidden="true"></span> Check Our Event Calendar</a>
			</div>
		</div>
		<div>
			...
			<p>You are invited to IMCC&rsquo;s Snapshot, an overview and tour, to see firsthand the work we are doing. Coffee and pastries are provided. You will meet the Executive Director, Joel, and hear about our unique approaches and the innovative practices that IMCC provides to individuals with memory impairment and their caregivers. <a href="javascript:void(0);" class="more-info-toggle" data-toggle="collapse" data-target="#more-info-insight-memory" aria-expanded="false" aria-controls="more-info-insight-memory">more event info</a></p>
