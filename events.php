    ...
    <div class="row">
        <section>
            <div>
                ...
                <div class="col-sm-5">
                    <div class="well event-well details-wishlist clearfix">
                        <img src="http://lorempixel.com/1200/400/nature" class="img-responsive" alt="">
                        <div class="clearfix">
            ...
            <div>
                ...
                <div class="col-sm-5">
                    <div class="well details-wishlist clearfix">
                        <h4 class="events-h4">Event Information</h4>
                        <ul class="list-unstyled event-details-list">
                        ...
                        <div class="addthis_sharing_toolbox" data-url="http://cfp-dc.org/aff"></div>
                        <!--part2-->
                        <script src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-4d7e615503d03f12" async="async"></script>
                        <script>
                            var addthis_config = addthis_config || {};
                            addthis_config.data_track_addressbar = false;
                            addthis_config.data_track_clickback = false;
