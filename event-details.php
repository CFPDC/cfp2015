...
<div class="row event-details-row">
	...
	<div class="col-sm-4">
		<a href="events-calendar.php" class="btn btn-info event-button hidden"><span class="fa fa-calendar"></span> Check Our Event Calendar</a>
	</div>
</div>
</div>
<div class="row">
...
<section class="col-sm-8">
	...
	<p class="see-also">See also: <a href="/cfpdc/all-events.php?category=HUMAN+SERVICES%3A+Health%2C+Mental+Health%2C+and+Aging">More upcoming events for Catalogue Nonprofits in HUMAN SERVICES: Health, Mental Health, and Aging </a></p>
</section>
</div>
</main>
