...
<div class="row">
	<section class="col-sm-8">
			...
			<div id="financial-snapshot" class="collapse">
				...
				<div class="col-sm-4 budget-container col-sm-offset-1">
					...
					<ul class="budget-status list-unstyled normal">
						...
						<li>$1 million to $3 million</li>
						<li>$500k to $1 million</li>
						<li>$100k to $500k</li>
						<li>Less than $100k</li>
					</ul>
				</div>
			</div>
		...
		<div id="carouselwrapper" class="carouselwrapper col-xs-10 col-xs-offset-1">
			<div id="related-carousel" class="carousel slide related-carousel-container" data-interval="false">
				...
				<span id="related-carousel-liveRegion" class="sr-only"> Slide Carousel backward </span>
				</button>
	...
	<aside class="col-sm-4 col-lg-offset-1 col-lg-3">
		<h3>Support <span class="sr-only" >2 Seeds</span></h3>
		...
		<div class="well details-wishlist text-center">
			<p><strong>$100:</strong> Consectetur adipiscing elit. Sed vitae egestas purus. LLorem  ipsum dolor sit amet, consectetur adipiscing elit. Sed vitae egestas purus. </p>
			<a href="checkout.php?np_title=2 Seeds&np_amount=100.00" class="btn btn-primary">Donate $100</a>
			<hr>
			<p><strong>$250:</strong> Consectetur adipiscing elit. Sed vitae egestas purus. LLorem  ipsum dolor sit amet, consectetur adipiscing elit. Sed vitae egestas purus. </p>
			<a href="checkout.php?np_title=2 Seeds&np_amount=250.00" class="btn btn-primary">Donate $250</a>
			<hr>
			<p><strong>$500:</strong> Consectetur adipiscing elit. Sed vitae egestas purus. LLorem  ipsum dolor sit amet, consectetur adipiscing elit. Sed vitae egestas purus. </p>
		...
		<h3>Contact <span class="sr-only">2 Seeds</span></h3>
		<div class="well details-contact">
			<h4>Amanda Satterwhite<br><small>Manager of Finance and Operations</small></h4>
			<address>
				<span class="street">641 S Street, NW, 3rd Floor </span>
				<span class="city-state">Washington, DC 20001</span>
				<a href="tel:760-519-6731" class="phone" title="call 2Seeds main office">760-519-6731</a>
				<a href="http://2seeds.org/" title="The Catalogue for Philanthropy's Website" target="_blank">www.2seeds.org</a>
			</address>
			<div class="nonprofit-social three-wide">
				<a href="javascript:void(0);" title="Follow 2 Seeds on Facebook"><span class="fa fa-facebook"><span class="sr-only">2 Seeds Facebook</span></span></a>
				<a href="javascript:void(0);" title="Follow 2 Seeds on Instagram"><span class="fa fa-instagram"><span class="sr-only">2 Seeds Instagram</span></span></a>
				<a href="javascript:void(0);" title="Follow 2 Seeds on Twitter"><span class="fa fa-twitter"><span class="sr-only">2 Seeds Twitter</span></span></a>
			</div>
		</div>
	</aside>
</div>
