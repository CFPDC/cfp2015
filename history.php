...
<div class="row">
			...
			<ul class="list-unstyled">
				...
				<li>
					...
					<ul>
						...
						<li>
							<a href="javascript:void(0);" class="current">Giving History</a>
						</li>
					</ul>
				</li>
				<li>
	...
	<section class="col-sm-8">
		<p>
			Interested in tracking past donations made on this site? If you have a (free) account, you will be able to view three years&rsquo; worth of past donations here (and we&rsquo;ll archive the rest). Just login on the top right of this screen. If you don&rsquo;t have an account, consider signing up at the CREATE AN ACCOUNT link on the upper left side of this screen.
		</p>
		<p>
			<a href="history_process.php" class="need-page">Already have a free donor account?  View your donation history here.</a>
		</p>
	</section>
</div>
</main>
