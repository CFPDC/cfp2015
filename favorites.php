...
<div class="row">
	<aside class="col-sm-3 who-we-are-nav" id="asideFilter">
		<ul class="list-unstyled">
			...
			<li><a href="javascript:void(0);" class="current">View Favorites</a></li>
	...
	<section class="col-sm-8">
		<p>Interested in creating a list of Saved Favorites?  First, make sure you have created a free account (sign up at Create An Account on the left side of the screen).  Then, browse <a href="our-nonprofits.php">Our Nonprofits</a> and click the &ldquo;add to favorites&rdquo; link when you discover organizations that you find intriguing&mdash;as volunteer opportunities, candidates for a gift, pages you&rsquo;d like to print, or for any other reason.  At your Saved Favorites page you will be able to make multiple donations, add items to a gift registry, or create and then print your own, personalized Catalogue. But first, browse <a href="our-nonprofits.php">Our Nonprofits</a>, click the &ldquo;add to favorites&rdquo; link as you find things that interest you, and then return here when you&rsquo;re ready.</p>
		<p><a href="favorites_process.php" class="needs-page" title="Visit the Saved Favorites page">View Saved Favorites</a></p>
	</section>
</div>
</main>
