...
<div class="row">
  <section class="col-md-10 col-lg-8">
    ...
    <h2>Checkout</h2>
    <p>Quisque id eleifend ipsum. Donec sit amet ligula pretium, consectetur ligula a, mollis ligula.</p>
    </div>
     <div class="express-checkout-heading" id="express-checkout-heading-section" style="display: none;">
    <h2>Express Checkout</h2>
    <p>Aliquam fermentum erat eu suscipit, quis finibus felis commodo. Sed sagittis suscipit sagittis. Sed vulputate consectetur ornare.</p>
    </div>
    <div class="row">
        ...
        <fieldset>
          ...
          <div class="row">
           ...
           <br>
                  ...
                  Express Checkout <button class="btn btn-link info-tooltip" data-toggle="tooltip" title="tooltip to explain what express checkout is..."><span class="fa fa-info-circle"></span></button></label>
                </div>
              </div>
            ...
            <div class="col-sm-6 express-checkout-section" style="display: none;">
              ...
              <div class="radio left">
                <div>
                <p id="checkboxDescriptor">Recurrence</p>
